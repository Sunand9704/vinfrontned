              ...
              <div className="bg-gray-800 rounded-xl shadow-sm overflow-hidden border border-green-700">
                <div className="divide-y divide-green-700">
                  {cart.map((item, index) => (
                    ...
                    >
                      <div className="flex-shrink-0 w-24 h-24 md:w-32 md:h-32 lg:w-40 lg:h-40 rounded-lg overflow-hidden bg-gray-700 border border-green-700 flex items-center justify-center">
                        {item?.product?.images &&
                        ...
                        >
                          <FaShoppingBag className="w-8 h-8 md:w-10 md:h-10 lg:w-12 lg:h-12" />
                        </div>
                      </div>
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between gap-4">
                          <h3 className="text-lg md:text-xl lg:text-2xl font-medium text-gray-200 truncate flex-1">
                            {item?.product?.name}
                          </h3>
                          <div className="flex items-center gap-2">
                            <p className="text-lg md:text-xl lg:text-2xl font-medium text-green-400">
                        ...
                        <p className="mt-2 text-sm md:text-base lg:text-lg text-gray-400">
                          ...
                          item?.product?.height ? (
                            <span>
                              ...
                              Length: {item.product.length} cm, Width:{" "}
                              {item.product.width} cm, Height:{" "}
                              {item.product.height} cm
                            </span>
                          ) : (
                            "item"
                          )}
                        ...
                        <div className="mt-4 md:mt-6 lg:mt-8 flex items-center gap-2 md:gap-3 lg:gap-4">
                          ...
                          <span className="mx-2 md:mx-3 lg:mx-4 text-base md:text-lg lg:text-xl text-gray-200 font-semibold">
                            {item.quantity}
                          </span>
                          <button
                            onClick={() =>
                            ...
                            disabled={
                              isLoading ||
                              item.quantity >= (item.product?.maxOrder || 100)
                            }
                            className="text-green-400 hover:text-green-300 disabled:opacity-50 disabled:cursor-not-allowed transition-colors border border-green-700 rounded-full w-8 h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 flex items-center justify-center"
                          >
