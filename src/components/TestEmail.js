    ...
    <Card className="mt-4">
      ...
      <Card.Body>
        <Form>
          ...
          <Button variant="primary" onClick={testEmail} disabled={loading}>
            {loading ? (
              <>
                <Spinner
                  as="span"
        ...
        {result && (
          <Alert variant="success" className="mt-3">
            ...
            <div className="mb-0">
              ...
              <p>
                <strong>User Email:</strong> {result.orderDetails.userEmail}
              </p>
              <p>
              ...
              <ul>
                {result.orderDetails.items.map((item, index) => (
                  <li key={index}>
                    {item.name} ({item.category || "N/A"}) - Quantity:{" "}
              ...
              <address>
                {result.orderDetails.address.street}
                <br />
                {result.orderDetails.address.city},{" "}
                {result.orderDetails.address.state}
                <br />
              ...
              <p>
                ...
                {new Date(
                  result.orderDetails.deliveryDate
                ).toLocaleDateString()}
              </p>
              <p>
                <strong>Delivery Time:</strong>{" "}
                {result.orderDetails.deliveryTime}
              </p>
            </div>
          </Alert>
        )}
