      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-4 md:gap-8">
          ...
          <div className="flex flex-col items-center space-y-2 md:space-y-4 w-full md:w-1/5">
            ...
            <h3 className="text-2xl md:text-4xl font-bold text-green-400">
              Vin2Grow
            </h3>
          ...
          <div className="flex flex-col items-center w-full md:w-1/5">
            <h4 className="text-base md:text-lg font-semibold mb-2 md:mb-4 text-green-400">
              Quick Links
            </h4>
          ...
          <div className="flex flex-col items-center w-full md:w-1/5">
            ...
            <ul className="space-y-2 md:space-y-4 text-center">
              <li className="flex items-center justify-center space-x-2 md:space-x-3">
                ...
                <a
                  href="https://www.google.com/maps/place/18%C2%B018'48.1%22N+78%C2%B015'03.6%22E/@18.313346,78.2484373,17z/data=!3m1!4b1!4m4!3m3!8m2!3d18.313346!4d78.2510122?entry=ttu&g_ep=EgoyMDI1MDczMC4wIKXMDSoASAFQAw%3D%3D"
                  target="_blank"
          ...
          <div className="flex flex-col items-center w-full md:w-1/5">
            ...
            <ul className="space-y-1 md:space-y-3 text-center">
              <li>
                <a
                  href="#"
                  className="flex items-center justify-center space-x-2 md:space-x-3 text-gray-300 hover:text-green-400 transition-colors"
                >
                  <svg
                    className="w-4 h-4 md:w-5 md:h-5 text-green-400 flex-shrink-0"
                    fill="currentColor"
              ...
              <li>
                <a
                  href="https://www.instagram.com/vin2grow.in"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center space-x-2 md:space-x-3 text-gray-300 hover:text-green-400 transition-colors"
                >
      ...
      <div className="border-t border-gray-700 mt-4 md:mt-8 pt-3 md:pt-6 bg-gray-800 md:bg-transparent">
        <div className="container mx-auto px-4">
          <div className="text-center text-gray-300 text-xs md:text-base font-medium py-2 md:py-4">
            ...
            <span className="text-green-400 font-bold">Vin2Grow</span>. All
